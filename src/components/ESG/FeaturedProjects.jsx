...
const FeaturedProjects = () => {
  ...
  return (
    <section className="py-20 px-6 md:px-16 lg:px-24 max-w-[1440px] mx-auto bg-white">
      ...
      {/* 6. Featured Projects Header Section */}
      <motion.div 
        initial="hidden"
        whileInView="visible"
        ...
        className="mb-16"
      >
        {/* Heading: Green/Blue Split with Reference Underline */}
        <div className="mb-6 w-fit text-left">
          ...
          >
            <span className="text-[#19d366]">Featured </span>
            <span style={{ color: 'var(--color-blue)' }}>Projects</span>
          </h2>
        ...
        <p 
          className="text-[16px] md:text-[18px] text-[#333] max-w-4xl leading-[1.8]"
          style={{ fontFamily: 'var(--font-helvetica)' }}
        >
          Our featured projects showcase real-world actions that involve sustainability, 
          empower communities, and promote responsible growth.
        </p>
      </motion.div>
        ...
        {projects.map((project, index) => (
          <motion.div 
            ...
            transition={{ 
              ...
              stiffness: 100, 
              damping: 15, 
              delay: index * 0.1 // Sequential staggered entry
            }}
