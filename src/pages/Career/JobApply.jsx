  ...
  return (
    <>
      <SEO
        ...
        description="Submit your job application to Renny Strips. Apply for careers in steel manufacturing, engineering, production, quality assurance, operations, and industrial innovation."
