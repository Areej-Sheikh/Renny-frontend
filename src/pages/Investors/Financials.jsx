...
const MOCK_DOCUMENTS = {
  audited: [
    { title: "Financial Year 2024–2025", url: "https://drive.google.com/file/d/1tLJzM-m5gCYEtwnRJgfIPuZUPqCRQMVn/view?usp=sharing" },
    { title: "Financial Year 2023–2024", url: "https://drive.google.com/file/d/1mYaC6COEz580dHvE-mbFLtj8n6liHZms/view?usp=sharing" },
    { title: "Financial Year 2022–2023", url: "https://drive.google.com/file/d/1K5Lu58_F8qEOwsObj04mYISPhkKmQy0B/view?usp=sharing" },
  ],
  creditors: [{ title: "Outstanding dues to Material Creditors", url: "https://drive.google.com/file/d/1vmRq875SIDwnez6ZeCsXiLqpZEl__-wt/view?usp=sharing" }],
  "renny-casting": [{ title: "Financial Year 2024–2025", url: "https://drive.google.com/file/d/1YsYw4THXGEUUkmPmFyuLeugtzYT5ezRh/view?usp=sharing" }],
  "noval-paints": [{ title: "Financial Year 2024–2025", url: "https://drive.google.com/file/d/1vdV5RQgIBfb2i9bzbc7msBZA4bajZNsG/view?usp=sharing" }],
  "annual-returns": [{ title: "Financial Year 2024–2025", url: "https://drive.google.com/file/d/1wt3c9JxebwtfKfds9KttVCQme-2H4kfl/view?usp=sharing" }],
};
      ...
      >
        <div className="max-w-[1400px] mx-auto grid grid-cols-12 gap-12 items-start">
          ...
          <div className="col-span-12 lg:col-span-8">
            <div className="inline-block text-white px-6 py-2 rounded-md mb-6 font-semibold text-[14px]" style={{ backgroundColor: brandColor }}>
              Investor Relations
            </div>
