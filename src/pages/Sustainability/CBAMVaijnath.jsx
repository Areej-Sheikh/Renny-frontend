    ...
    >
      ...
      <div>
        ...
        {/* <button
          ...
          className="mt-3 text-green font-semibold hover:underline"
        >
          Read More
        </button> */}
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="hidden lg:block">
            <div className="relative h-[720px]">
              ...
              <motion.div
                variants={fadeUp}
                className="absolute top-10 left-10/18 -translate-x-1/2 w-[340px]"
              >
                <CredentialCard1
                  item={credentials[0]}
                  reverse={false}
              ...
              <motion.div
                variants={fadeUp}
                className="absolute top-58 left-30 w-[320px]"
              >
                <CredentialCard1
                  item={credentials[1]}
                  reverse={true}
              ...
              <motion.div
                variants={fadeUp}
                className="absolute top-58 right-30 w-[320px]"
              >
                <CredentialCard1
                  item={credentials[2]}
                  reverse={false}
              ...
              <motion.div
                variants={fadeUp}
                className="absolute bottom-20 left-46 w-[320px]"
              >
                <CredentialCard1
                  item={credentials[3]}
                  reverse={true}
              ...
              <motion.div
                variants={fadeUp}
                className="absolute bottom-6 right-45 w-[320px]"
              >
                <CredentialCard1
                  item={credentials[4]}
                  reverse={false}
